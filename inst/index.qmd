...
intro <- tryCatch(
    {
        description <- packageDescription("book2")
...
👉 [ghcr.io/lgatto/book2](https://ghcr.io/lgatto/book2) 🐳
...
#| eval: false
docker run -it ghcr.io/lgatto/book2:devel R
```
...
#| eval: false
docker run -it ghcr.io/lgatto/book2:devel bash
